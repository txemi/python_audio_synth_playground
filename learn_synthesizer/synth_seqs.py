...
time.sleep(1)
play_scale_from_freq(txtone.TxTones.A4_freq, tx_scale.mayor, 0.2)
time.sleep(1)
play_scale_from_freq(txtone.TxTones.A4_freq, tx_scale.blues, 0.2)
time.sleep(1)
play_scale_from_freq(txtone.TxTones.A4_freq, tx_scale.doble_armonica, 0.2)
