...
play_for(sine_wave(txnote_khe_wrap.note_A4.freq, sample_rate_4096), on_sec_in_ms)

# Play A-440 for 1 second as a square wave:
play_for(square_wave(txnote_khe_wrap.note_A4.freq, sample_rate_4096), on_sec_in_ms)
