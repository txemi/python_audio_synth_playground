...
time.sleep(1)
play_scale_from_freq(note_names_and_freq_static.note_A4.freq, txscales_examples.blues, 0.2)
time.sleep(1)
play_scale_from_freq(note_names_and_freq_static.note_A4.freq, txscales_examples.doble_armonica, 0.2)
