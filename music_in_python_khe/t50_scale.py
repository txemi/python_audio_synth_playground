...
from txpymusiclib.scales_package.scale_static_examples_from_note_names import c_major_scale_notes_2
...
scale_plain = synt_song_khe.get_song_data(c_major_scale_notes_2, note_values, bar_value=0.5,
...
scale_sustain = synt_song_khe.get_song_data(c_major_scale_notes_2, note_values, bar_value=4,
                                            factor=factor, length=length, decay=decay,
                                            sustain_level=sustain_level)
