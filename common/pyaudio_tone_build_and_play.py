from common.wave.stream_sin_data_for_freq import DEFAULTRATE
from common.wave.stream_sin_data_for_freq import build_sin_data_for_freq_1, build_sin_data_for_freq_2
